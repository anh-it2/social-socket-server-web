...
export interface NotificationClientToServerEvents {
    "notification:first-user": (ack: (res: FirstUserResponseDTO) => void) => void;
    "notification:list": (ack: (res: NotificationListResponseDTO) => void) => void;
    "notification:emit": (data: EmitNotificationDTO, ack: (res: NotificationActionAck) => void) => void;
    "notification:read": (data: MarkReadDTO, ack: (res: NotificationActionAck) => void) => void;
    "notification:read-all": (ack: (res: NotificationActionAck) => void) => void;
}
